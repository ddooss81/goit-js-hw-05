...
// const genres = books.flatMap(gen => gen.title);
// console.log(genres);
...
// const listOfEmails = emails(users);
...
// const evenNumbers = numbers.filter((namberPlus) => {return namberPlus % 2 === 0});
// const oddNumbers = numbers.filter((namberPlus) => {return namberPlus % 2 !== 0});
